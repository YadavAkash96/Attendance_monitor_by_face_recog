'''
We can also Implement  Dlib Face alignment strategy
...
class AlignCustom(object):
    ...
    def align(self, desired_size, img, landmarks, padding=0.1):
        """
        landmark : face features like left_eye_left_corner_points_co-ordinates
        ...
        #after detection boundingbox this mean position for x,y
        ...
        for i in range(int(len(shape) / 2)):
            x = (padding + mean_face_shape_x[i]) / (2 * padding + 1) * desired_size#scale*width
